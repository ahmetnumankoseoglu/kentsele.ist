  ...
  return (
    <section className="card-elevated not-prose mt-2 p-4 sm:p-5">
      ...
      <p className="mt-1 text-xs leading-relaxed text-[#6b7280]">
        Binanızda hem konut hem dükkân olabilir. Aşağıya <strong>konut</strong>{" "}
        ve <strong>ticari</strong> birim adedini birlikte girin; tutarlar sabit
      ...
      <p className="mt-3 text-[11px] leading-relaxed text-[#9ca3af]">
        Tutarlar Cumhurbaşkanı / Kentsel Dönüşüm Başkanlığı açıklamalarındaki
        güncel Yarısı Bizden rakamlarına dayanır. Aylık kira yardımı bu paketten
        ayrıdır;{" "}
