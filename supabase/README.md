...
12. `seed.sql` — isteğe bağlı örnek ilanlar (geliştirme)
...
### İlan e-posta ile hesaba bağlanmıyorsa

`011_link_listings_by_email.sql` çalıştır (opsiyonel ama önerilir). Uygulama RPC yoksa da JS ile bağlar; Hesabım açılınca dener.
